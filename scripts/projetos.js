...
import { PAGE_COLORS, ANIMATION_CONFIG } from './config.js';
...
const pageConfig = PAGE_COLORS.projetos;
...
// Criar core
const core = createCore('icosahedron', pageConfig.accent, 1.5);
scene.add(core);
...
function animate() {
    ...
    // Rotacionar core
    core.rotation.y += ANIMATION_CONFIG.coreRotation.projetos.y;
    core.rotation.x += ANIMATION_CONFIG.coreRotation.projetos.x;
